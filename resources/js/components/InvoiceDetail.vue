        ...
        <div class="pb-2">
            ...
            <div class="bg-[#f3f3f3] p-2">
                ...
                <div class="grid grid-cols-2 mb-2">
                    ...
                    <div class="text-right text-[13px] text-gray-500">{{ invoice && invoice.tax_information.tax_amount
                        }}</div>
                </div>

                <div class="grid grid-cols-2 mb-2">
                    <div class="text-[16px] text-s-green-200 font-bold">Total</div>
                    <div class="text-right text-[16px] text-s-green-200 font-bold">${{ invoice && `${totalProduct +
                        invoice.tax_information.tax_amount}`}}</div>
                </div>
            </div>
